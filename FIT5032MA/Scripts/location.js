...
* @author Yun Wang 
*/
const TOKEN = "pk.eyJ1IjoieXdhbjA4MjgiLCJhIjoiY2t0aW5ocHhpMTNzZTJ2cDhxMmdqOGdwYSJ9.CVbARzo5PPOnkTM_oxuEtQ";
var locations = [];
...
var map = new mapboxgl.Map({
    ...
    zoom: 11,
    center: [locations[2].longitude, locations[2].latitude]
});
